pipeline {
  ...
  environment {
        GIT_NAME = "eea.dexterity.themes"
        SONARQUBE_TAGS = "demo-www.eea.europa.eu,www.eea.europa.eu-en,www.eea.europa.eu,biodiversity.europa.eu,industry.eea.europa.eu,forest.eea.europa.eu"
    }
          ...
          "Ruff": {
            node(label: 'docker') {
              script {
                ...
                sh '''cp -rf eea.dexterity.themes/* .'''
                sh '''rm -rf eea.dexterity.themes'''
